...
namespace CompassNavigatorPro {
    ...
    public class CompassNavigatorProInspector : Editor {
        ...
        SerializedProperty showCompassBar, style, compassBackSprite, compassBackSpriteScrollable, compassTintColor, bendAmount, width, height, verticalPosition, horizontalPosition, endCapsWidth, edgeFadeOut, edgeFadeOutWidth, edgeFadeOutStart, edgeFadeOutText;
