...
namespace CompassNavigatorPro {
    ...
    public partial class CompassProPOI : MonoBehaviour {
        ...
        [Tooltip("Altitude of this POI in meters. Used for display purposes.")]
        public float altitude;

        [Tooltip("Heading of this POI in degrees. Used for display purposes.")]
        ...
        public TextMeshProUGUI indicatorDistanceText, indicatorTitleText, indicatorAltitudeText, indicatorHeadingText;

        [NonSerialized]
        public float prevIndicatorDistance, lastCompassIconDistance, prevIndicatorAltitude, prevIndicatorHeading;
        [NonSerialized]
        public string lastIndicatorDistanceText, lastCompassIconDistanceText, lastIndicatorAltitudeText, lastIndicatorHeadingText;
