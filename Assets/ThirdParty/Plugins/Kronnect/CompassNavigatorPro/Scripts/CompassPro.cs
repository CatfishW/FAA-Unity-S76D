...
namespace CompassNavigatorPro {
    ...
    public partial class CompassPro : MonoBehaviour {
        ...
        [SerializeField]
        string _onScreenIndicatorShowDistanceFormat = "0nm";
        ...
        [Tooltip("Whether the altitude should be displayed for POI indicators")]
        [SerializeField]
        bool _onScreenIndicatorShowAltitude = true;

        /// <summary>
        /// Whether the altitude should be displayed for POI indicators
        /// </summary>
        public bool onScreenIndicatorShowAltitude {
            get { return _onScreenIndicatorShowAltitude; }
            set {
                if (value != _onScreenIndicatorShowAltitude) {
                    _onScreenIndicatorShowAltitude = value;
                }
            }
        }

        [Tooltip("The string format for displaying the altitude on the indicators. Altitude is shown as relative hundreds of feet (+01 = 100ft above, -05 = 500ft below)")]
        [SerializeField]
        string _onScreenIndicatorShowAltitudeFormat = "+00";

        /// <summary>
        /// The string format for displaying the altitude (currently not used - altitude is formatted as relative hundreds of feet).
        /// Altitude display format: +01 = 100ft above reference, -05 = 500ft below reference.
        /// </summary>
        public string onScreenIndicatorShowAltitudeFormat {
            get { return _onScreenIndicatorShowAltitudeFormat; }
            set {
                if (value != _onScreenIndicatorShowAltitudeFormat) {
                    _onScreenIndicatorShowAltitudeFormat = value;
                }
            }
        }

        [Tooltip("Whether the heading should be displayed for POI indicators")]
        [SerializeField]
        bool _onScreenIndicatorShowHeading = true;

        /// <summary>
        /// Whether the heading should be displayed for POI indicators
        /// </summary>
        public bool onScreenIndicatorShowHeading {
            get { return _onScreenIndicatorShowHeading; }
            set {
                if (value != _onScreenIndicatorShowHeading) {
                    _onScreenIndicatorShowHeading = value;
                }
            }
        }

        [Tooltip("The string format for displaying the heading on the indicators. Heading is shown in degrees (000-359)")]
        [SerializeField]
        string _onScreenIndicatorShowHeadingFormat = "000°";

        /// <summary>
        /// The string format for displaying the heading (currently not used - heading is formatted as 3-digit degrees).
        /// Heading display format: 090° = heading east, 180° = heading south, etc.
        /// </summary>
        public string onScreenIndicatorShowHeadingFormat {
            get { return _onScreenIndicatorShowHeadingFormat; }
            set {
                if (value != _onScreenIndicatorShowHeadingFormat) {
                    _onScreenIndicatorShowHeadingFormat = value;
                }
            }
        }
        ...
        [SerializeField]
        string _titleShowDistanceFormat = "0.0nm";
        ...
        [SerializeField]
        string _showDistanceFormat = "0nm";
