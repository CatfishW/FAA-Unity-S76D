...
{ 
    ...
    { 
        ...
        [Tooltip("Layer mask to block objects in TPS mode.")]
        ...
        { 
            ...
            blockLayerMask = LayerMask.GetMask("UI");
        } 
        ...
        void CameraMovement()
        {
            ...
            // Block objects of layer UI
            RaycastHit hit;
            if (Physics.Raycast(Target.position, transform.position - Target.position, out hit, distance, blockLayerMask))
            {
