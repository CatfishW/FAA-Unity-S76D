...
namespace HUDIndicator {
	...
	public class IndicatorOnScreen : Indicator {
		...
		// protected override void CreateDistanceDisplay(IndicatorRenderer renderer) {
		// 	IndicatorCanvasOnScreen indicatorCanvasOnScreen = indicatorsCanvas[renderer] as IndicatorCanvasOnScreen;
		// 	indicatorCanvasOnScreen.CreateText(distanceDisplay);
		// }
	}
