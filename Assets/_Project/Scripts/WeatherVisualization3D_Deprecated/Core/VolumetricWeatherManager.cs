...
namespace WeatherVisualization3D
{
    ...
    public class VolumetricWeatherManager : MonoBehaviour
    {
        ...
        // [SerializeField] private bool _showVolumetricClouds = true; // Removed - no volumetric clouds
        ...
        // ShowVolumetricClouds property removed - no volumetric clouds
        ...
        private void UpdateLayerVisibility()
        {
            foreach (var renderer in _renderers)
            {
                ...
                {
                    // layered.SetLayerVisible(RenderLayer.VolumetricClouds, _showVolumetricClouds); // Removed - no volumetric clouds
                ...
                else
                {
                    ...
                    renderer.IsVisible = true; // Default to visible for non-volumetric renderers
                }
            }
        ...
        public void SetLayerVisible(RenderLayer layer, bool visible)
        {
            switch (layer)
            {
                // case RenderLayer.VolumetricClouds: // Removed - no volumetric clouds
