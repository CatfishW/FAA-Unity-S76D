...
namespace WeatherVisualization3D
{
    ...
    public class WeatherPrefabRegistry : ScriptableObject
    {
        ...
        // [Tooltip("Volumetric cloud volume renderer prefab")] // Removed - no volumetric clouds
        ...
        public bool IsComplete()
        {
            return weatherSystemRoot != null &&
                   ...
                   // volumetricCloudVolume != null && // Removed - no volumetric clouds
        ...
        public string[] GetMissingPrefabs()
        {
            ...
            // if (volumetricCloudVolume == null) missing.Add("Volumetric Cloud Volume"); // Removed - no volumetric clouds
