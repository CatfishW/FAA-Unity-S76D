    ...
    public static class WeatherPrefabFactory
    {
        ...
        public static void CreateAllPrefabs()
        {
            ...
            try
            {
                ...
                // CreateVolumetricCloudVolumePrefab(); // Removed - no volumetric clouds
        ...
        public static void CreateMissingPrefabsOnly()
        {
            ...
            // VolumetricCloudVolume removed - no volumetric clouds
        ...
        private static void UpdateRegistryReferences(WeatherPrefabRegistry registry)
        {
            ...
            // registry.volumetricCloudVolume removed - no volumetric clouds
