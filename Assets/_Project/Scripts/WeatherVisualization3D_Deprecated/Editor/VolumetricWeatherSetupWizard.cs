...
namespace WeatherVisualization3D
{
    ...
    public class VolumetricWeatherSetupWizard : EditorWindow
    {
        ...
        // private bool createCloudRenderer = true; // Removed - no volumetric clouds
        ...
        {
            CreateFullSetup(ScenarioType.ThunderstormCells, true, true, true); // No clouds param
        }
        ...
        public static void OpenDocumentation()
        {
            ...
            string readmePath = "Assets/_Project/Scripts/WeatherVisualization3D_Deprecated/README.md";
            ...
            else
            {
                ...
                Application.OpenURL("https://github.com/CatfishW/FAA/tree/master/Assets/_Project/Scripts/WeatherVisualization3D_Deprecated");
            }
        }
        ...
        private void DrawComponentsSection()
        {
            ...
            // Volumetric Cloud Renderer removed - no volumetric clouds
        ...
        private void CreateSetup()
        {
            CreateFullSetup(
                selectedScenario,
                // createCloudRenderer, // Removed - no volumetric clouds
                createPillarRenderer,
                createLightningEffect,
                createPrecipitationEffect
            );
        ...
        public static void CreateFullSetup(
            ...
            // bool clouds, // Removed - no volumetric clouds
            bool pillars,
            bool lightning,
            bool precipitation)
        {
            ...
            GameObject root = WeatherPrefabFactory.InstantiateWeatherSystem(false, pillars, lightning, precipitation); // clouds=false - no volumetric clouds
        ...
        private void RemoveExistingSetup()
        {
            ...
            // var cloudRenderers = FindObjectsOfType<VolumetricCloudVolume>(); // Removed - no volumetric clouds
            ...
            // foreach (var c in cloudRenderers) { DestroyImmediate(c.gameObject); count++; } // Removed - no volumetric clouds
