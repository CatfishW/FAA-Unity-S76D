...
using UnityEngine;
    ...
    public class ZstdLoadTest : MonoBehaviour
    {
        ...
        void Start()
        {
            var before = Resources.Load<TextAsset>("txt/sample0").bytes;
            var deflated = Resources.Load<TextAsset>("sample_deflated").bytes;
            var dictdeflated = Resources.Load<TextAsset>("sample_dictdeflated").bytes;
